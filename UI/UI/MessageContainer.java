...
public class MessageContainer extends HBox{
    private Color DEFAULT_SENDER_COLOR = Color.BLUE;
    private Color DEFAULT_RECEIVER_COLOR = Color.GRAY;
    ...
    public MessageContainer(String message, SpeechDirection direction){
